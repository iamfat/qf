(function($){
	...
	$('div[src] a[href]:not(.view, [q-event], .prevent_default, .group_prevent_default a)').live('click', function(){
	...
	$('div[src] form:not(.view, [q-event], .prevent_default)').livequery(function(){
		var $form = $(this);
